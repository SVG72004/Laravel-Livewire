    ...
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <form id="UserForm1" class="row g-3" method="post" action="{{route('addUser')}}" >
                    @csrf
    ...
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <form id="updateUserForm" class="row g-3" method="post" action="{{route('updateUser')}}">
                    @csrf
...
<div class="modal fade" id="addRoleModal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content p-3 p-md-5">
        ...
        <!-- Add role form -->
        <form id="addRoleForm" class="row g-3" onsubmit="return false" method="post" action="{{route('addRole')}}">
            @csrf
...
<div class="modal fade" id="editRole" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content p-3 p-md-5">
        ...
        <!-- Add role form -->
        <form id="updateRoleForm" class="row g-3" method="post" action="{{route('updateRole')}}">
            @csrf
