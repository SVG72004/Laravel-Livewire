<!DOCTYPE html>
@php
    // $currentLanguage = session('user_locale', 'en');
    $currentLanguage = session('user_locale', 'ar');
@endphp
{{--  <html lang="{{ str_replace('_', '-', app()->getLocale()) }}" lang="en" class="light-style customizer-hide light-style layout-navbar-fixed layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="http://127.0.0.1:8000/assets/" data-template="vertical-menu-template">  --}}
<html lang="{{ str_replace('_', '-', $currentLanguage) }}" dir="{{ $currentLanguage === 'ar' ? 'rtl' : 'ltr' }}" class="light-style customizer-hide light-style layout-navbar-fixed layout-menu-fixed" data-theme="theme-default" data-assets-path="http://127.0.0.1:8000/assets/" data-template="vertical-menu-template">
