...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboards -->
        <li class="menu-item @if(Str::contains(request()->url() ,'/dashboard')) active open @endif">
            <a href="" class="menu-link">
                <i class="menu-icon tf-icons ti ti-smart-home"></i>
                {{--  <div data-i18n="Dashboards">{{ trans('layouts.dashboard') }}</div>  --}}
                <div>Dashboard</div>
        ...
        <li class="menu-item @if(Str::contains(request()->url() ,'users')) active open @endif">
            <a href="" class="menu-link">
                <i class="menu-icon tf-icons ti ti-users"></i>
                {{--  <div data-i18n="Users">{{ trans('layouts.users') }}</div>  --}}
                <div>Users</div>
            </a>
            {{--  <ul class="menu-sub">
                <li class="menu-item @if(Str::contains(request()->url() ,'users')) active @endif">
        ...
        {{--  <li class="menu-item @if(Str::contains(request()->url() ,'supplier_list')) active open @endif">
            <a href="" class="menu-link">
                <i class="menu-icon tf-icons ti ti-users"></i>
                <div data-i18n="Supplier">Suppliers</div>
            </a>
        </li>  --}}

        {{--  <li class="menu-item @if(Str::contains(request()->url() ,'tag_list')) active open @endif">
            <a href="" class="menu-link">
        ...
        {{--  <li class="menu-item @if(Str::contains(request()->url() ,'settings')) active open @endif">
            <a href="" class="menu-link">
